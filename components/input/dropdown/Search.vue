<template>
    <div class="select-none">
        <div :class="this.config.ring" class="transition duration-300 flex flex-row justify-between items-center content-center bg-white rounded-xl h-10 shadow-md pl-4 gap-2">
            <input  @focus="toggleActivate" @blur="toggleBlur" type="text" id="data" v-model="data.search" :placeholder="this.placeholder" class="cursor-pointer focus:cursor-text h-6 bg-transparent focus:outline-none" />
